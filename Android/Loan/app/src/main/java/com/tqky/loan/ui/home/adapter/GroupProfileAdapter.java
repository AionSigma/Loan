...
public class GroupProfileAdapter extends RecyclerView.Adapter {
    private List<User> list;

    public GroupProfileAdapter(List<User> list) {
        this.list = list;
        if (this.list == null) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.item_group_profile, viewGroup, false);
